  ...
  return (
    ...
    <NavigationContainer>
      <Stack.Navigator initialRouteName='SplashScreen'  >
        ...
        <Stack.Screen name='Home' component={Home} options={{headerStyle:{backgroundColor:'rgb(17, 77, 72)'},headerTintColor:'#FFF',headerTitle: (props) => <LogoTitle {...props} />,headerTitleAlign:'center'}} />
